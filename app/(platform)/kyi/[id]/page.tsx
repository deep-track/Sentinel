...
// NOTE: getKYIRecord and refreshKYIFromShufti previously came from
// actions/kyi.ts, which was removed as part of the Convex backend
// migration. There is no public Convex query yet for fetching a single
// KYI record by ID, so this page cannot load real data. Showing an
// honest unavailable state instead of faking a record.
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="rounded-xl border border-amber-200 dark:border-amber-800 bg-amber-50 dark:bg-amber-900/10 p-8 text-center">
          <p className="text-amber-700 dark:text-amber-400 font-medium">
            Record details for {id} are temporarily unavailable while the
            backend migrates to Convex.
          </p>
        </div>
      </div>
    </div>
