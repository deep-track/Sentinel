...
// NOTE: getKYCRecord and refreshKYCFromShufti previously came from
// actions/kyc.ts, which was removed as part of the Convex backend
// migration. There is no public Convex query yet for fetching a single
// KYC record by ID, so this page cannot load real data. Showing an
